...
class Option
{
    ...
    public static function getEntry()
    {
        return Setting::firstOrCreate([
            'key' => 'chilltvpack/chilltv-crawler.options',
        ], [
            'name' => 'Options',
    ...
    {
        $categories = Cache::remember('chilltv_categories', 86400, function () {
        ...
        $regions = Cache::remember('chilltv_regions', 86400, function () {
